...
const GIVEAWAY_SEEDS: GiveawaySeed[] = [
  {
    ...
    art: { from: "#2563eb", to: "#0ea5e9", emoji: "🎮", shape: "console-white" },
    status: "live",
  ...
  },
  {
    ...
    liveUrl: "https://www.tiktok.com/@ggplay/live",
    art: { from: "#7c3aed", to: "#db2777", emoji: "🖥️", shape: "gaming-pc" },
    status: "live",
  ...
  },
  {
    ...
    liveUrl: "https://www.tiktok.com/@ggplay/live",
    art: { from: "#f97316", to: "#facc15", emoji: "⌨️", shape: "peripherals" },
    status: "live",
  ...
  },
  {
    ...
    liveUrl: "https://www.tiktok.com/@ggplay/live",
    art: { from: "#0d9488", to: "#22c55e", emoji: "🕹️", shape: "handheld" },
    status: "live",
  ...
  },
  {
    ...
    liveUrl: "https://www.tiktok.com/@ggplay/live",
    art: { from: "#e11d48", to: "#f43f5e", emoji: "🍄", shape: "hybrid" },
    status: "closed",
  ...
  },
  {
    ...
    liveUrl: "https://www.tiktok.com/@ggplay/live",
    art: { from: "#16a34a", to: "#4ade80", emoji: "🟩", shape: "console-dark" },
    status: "drawn",
  ...
  },
  {
    ...
    liveUrl: "https://www.tiktok.com/@ggplay/live",
    art: { from: "#0891b2", to: "#38bdf8", emoji: "🖱️", shape: "monitor-chair" },
    status: "drawn",
